...
public class CnCompositionPageAdapter extends BaseViewPagerAdapter<BaseWordExplainFragment> {

    private String[] mTabName = {"标题查询","分类查询"};

    public CnCompositionPageAdapter(ArrayList<BaseWordExplainFragment> viewlist, FragmentManager fragmentManager) {
