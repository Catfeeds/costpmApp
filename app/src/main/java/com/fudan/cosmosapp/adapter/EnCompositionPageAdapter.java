...
public class EnCompositionPageAdapter extends BaseViewPagerAdapter<BaseWordExplainFragment> {

    private String[] mTabName = {"标题查询","分类查询"};

    public EnCompositionPageAdapter(ArrayList<BaseWordExplainFragment> viewlist, FragmentManager fragmentManager) {
